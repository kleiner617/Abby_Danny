	...
	render() {
		return (
			<FAQDetails className={this.props.className} id={this.props.id}>
				<Title {...this.props}>Things To Do</Title>
				{/* <Details>
					<DetailsText {...this.props}>
						{' '}
						<div>The venue will open at 6pm</div>
						<div>Dinner will be provided by Urban Roost</div>
						<div>Beer and Wine will be available at the bars</div>
					</DetailsText>
				</Details> */}
			</FAQDetails>
		);
